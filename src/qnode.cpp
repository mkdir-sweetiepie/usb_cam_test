...
#include <sstream>
#include "../include/usb_cam_test/qnode.hpp"

/*****************************************************************************
** Namespaces
*****************************************************************************/

namespace usb_cam_test
{
/*****************************************************************************
** Implementation
*****************************************************************************/
...
bool QNode::init()
{
  ros::init(init_argc, init_argv, "usb_cam_test");
  if (!ros::master::check())
  {
    return false;
  }
  ...
  subImage = image.subscribe("/usb_cam/image_raw", 1, &QNode::callbackImage, this);  // 서브스크라이버
